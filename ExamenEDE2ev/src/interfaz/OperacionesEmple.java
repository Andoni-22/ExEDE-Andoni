...
public class OperacionesEmple extends JDialog {
	public final class botonModificar implements ActionListener {
	...
	public final class botonBorrar implements ActionListener {
	...
	public final class botonConsultar implements ActionListener {
	...
	public final class botonInsertar implements ActionListener {
	...
	public OperacionesEmple() {
		...
		btnInsertar.addActionListener(new botonInsertar());
		
		//Accion boton consultar
		btnConsultar.addActionListener(new botonConsultar());
		
		//Accion boton borrar
		btnBorrar.addActionListener(new botonBorrar());
		
		//Accion boton modificar
		btnModificar.addActionListener(new botonModificar());
	}
}
