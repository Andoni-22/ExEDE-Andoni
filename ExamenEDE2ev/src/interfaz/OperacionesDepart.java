...
public class OperacionesDepart extends JDialog implements InterfazDepartInsertar, InterfazDepartBorrar, InterfazDepartConsultar, InterfazDepartModificar {
	private static final String BBDD="Empleados.dat";
	private Etiquetas data = new Etiquetas();
